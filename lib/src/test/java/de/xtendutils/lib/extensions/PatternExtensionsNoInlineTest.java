...
import static de.xtendutils.lib.extensions.PatternExtensions.compile;
...
/**
 * Perform the tests for methods the Xtend compiler will inline
 * here as well in order to check if the implementation is correct.
 */
